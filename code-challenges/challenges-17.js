...
const filterLinks = (str) => {
    // write your code here
    let f=str.indexOf("http://");
let s;
let arr = [".org",".com",".net"];
for(let i=0;i<3;++i)
if(str.indexOf(arr[i],f+11)!=-1)
s=str.indexOf(arr[i],f+11);
let res_str ="";
res_str=str.substring(f+7, s+4);
return res_str;
}
// -------------------------------------------------------------------------------------------------------
...
const isPalindrome = (str) => {
    ...
    let alp = str.replace(/[^0-9a-zA-Z]/g, '');
    alp=alp.toLowerCase();
    let s= alp.length; 
     let e=s-1;
    for(let i=0;i<s/2;++i){
